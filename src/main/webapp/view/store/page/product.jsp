...
<div class="container-xxl py-5">
    <div class="container" style="padding-top: 90px;">
        ...
        <form method="get" action="${pageContext.request.contextPath}/product" class="position-relative mx-auto" style="max-width: 400px; margin-bottom: 20px">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="w-100 d-flex flex-column text-start ps-4">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <small class="fst-italic"><%=product.getDescription()%></small>
                                        <button onclick="addToCart(<%=product.toJson()%>)" class="btn btn-dark">Thêm vào giỏ</button>
                                    </div>
                                </div>
                            </div>
                        </div>
